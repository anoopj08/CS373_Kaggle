...
pipeline = Pipeline([
    ...
    ('vot_clf', VotingClassifier(estimators=[('mnb',clf),('rf',rf),('svc',svc)])),
])
...
parameters = {
    ...
    #'mnb_clf__alpha': (0.01,0.3,0.5,1.0),
    # 'vot_clf__estimators': ([('mnb',clf),('rf',rf),('svc',svc)],[('mnb',clf),('svc',svc)]),
    #'vot_clf__voting': ('hard','soft'),
    'vot_clf__weights': ([1,1,1],[2,1,2],[2,1,3],[1,2,1],[1,2,2])
}
